...
export const dai = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0x247286dB95d409D3d29151Fcf9A20F0841917f79",    // Dai Bond Depository address
...
export const busd = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0xbdb0aa077448F22a0d0fB80aD35c522E9195866c",
...
export const allBonds = [/* dai, ohm_dai, */ busd/* , mtn_busd */ ];//mtn_wbnb, cake
