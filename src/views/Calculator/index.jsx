...
function Calculator() {
    ...
    const ecoinBalance = useSelector(state => {
        return state.account.balances && state.account.balances.sohm;
    });

    const trimmedStakingAPY = trim(stakingAPY * 100, 1);
    const trimmedEcoinBalance = trim(Number(ecoinBalance), 4);
    const trimeMarketPrice = trim(marketPrice, 2);

    const [ecoinAmount, setEcoinAmount] = useState(trimmedEcoinBalance);
    ...
    const calcInitialInvestment = () => {
        const shec = Number(ecoinAmount) || 0;
    ...
    }, [days, rewardYield, futureMarketPrice, ecoinAmount]);
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-apy">
                                            <Typography variant="h5" color="textSecondary">ROBOT Price</Typography>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-index">
                                            <Typography variant="h5" color="textSecondary">Your ECOIN Balance</Typography>
                                            <Typography variant="h4">{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedEcoinBalance} ECOIN</>}</Typography>
                                        </Box>
                                    </Grid>
                                </Grid>
                            </Box>
                        ...
                        <Box className="calculator-card-area">
                            <Box>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">ECOIN Amount</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                                    value={ecoinAmount}
                                                    onChange={e => setEcoinAmount(e.target.value)}
                                                    labelWidth={0}
                                                    endAdornment={
                                                        <InputAdornment position="end">
                                                            <div onClick={() => setEcoinAmount(trimmedEcoinBalance)} className="stake-card-action-input-btn">
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">ROBOT price at purchase ($)</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">Future ROBOT market price ($)</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                ...
                                <Box className="calculator-user-data">
                                    ...
                                    <Box className="data-row">
                                        <Typography>ROBOT rewards estimation</Typography>
                                        <Typography>{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} ROBOT</>}</Typography>
                                    </Box>
                                    <Box className="data-row">
