            ...
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric wsoprice">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "wECOIN = ECOIN * index\n\nThe price of wECOIN is equal to the price of RBOOT multiplied by the current index"
                    }
                  />
                </Typography>
              ...
              <Box className="metric index">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of ECOIN accumulated since the beginning of staking. Basically, how much ECOIN one would have if they staked and held a single RBOOT from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " ECOIN" : <Skeleton type="text" />}
                </Typography>
              </Box>
              {/* <Box className="metric runway">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "Runway, is the number of days ECOIN emissions can be sustained at a given rate. Lower APY = longer runway"
                    }
                  />
                </Typography>
                <Typography variant="h5">
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                <Chart
                  ...
                  headerText="Protocol Owned Liquidity RBOOT-DAI"
